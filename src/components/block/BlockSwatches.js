...
export const BlockSwatches = ({ colors, onClick, onSwatchHover, onResetBtnClick }) => {
  ...
  return (
    <div style={ styles.swatches }>
      ...
      <div onClick={ () => onResetBtnClick() } style={{ ...styles.swatches, cursor: 'pointer', marginBottom: '5px' }}>
